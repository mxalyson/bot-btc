...
Baseado em análise de 365 dias (58.9% WR, +2101% ROI)
Otimizações: Bloqueia low_vol_bull (49.4% WR), confiança adaptativa, position sizing dinâmico
"""
...
def main():
    ...
    print(f"   - Blocked Regimes: low_vol_bull (49.4% WR)")
    ...
    print("\n" + "=" * 80)
    print("📊 WALK-FORWARD RESULTS (OPTIMIZED)")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("📊 REGIME-BASED PERFORMANCE (OPTIMIZED)")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("📊 FULL BACKTEST + MONTE CARLO (OPTIMIZED)")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("✅ OPTIMIZED VALIDATION COMPLETE")
    print("=" * 80)
