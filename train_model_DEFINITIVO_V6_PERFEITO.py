...
print("=" * 80)
print("🚀 MODELO DEFINITIVO V6 - 6 MODELOS PERFEITOS")
print("=" * 80)
print()
...
def train_final_completo(df, days):
    """Treina MODELO DEFINITIVO V6 - 6 MODELOS PERFEITOS."""
    ...
    if use_dl:
        ...
        # Train LSTM
        lstm_model = create_lstm_model(input_shape=(lookback, X_train_balanced.shape[1]), dropout=0.5)
        ...
        cnn_model = create_cnn_model(input_shape=(lookback, X_train_balanced.shape[1]), dropout=0.5)
...
if __name__ == "__main__":
    ...
    for days in test_periods:
        ...
        # Save
        model_file = storage_dir / f"model_DEFINITIVO_V6_{days}d.pkl"
    ...
    print(f"   storage/models/model_DEFINITIVO_V6_{best_days}d.pkl")
    print()
