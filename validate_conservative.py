"""
VALIDAÇÃO ULTRA CONSERVADORA - Focado em Máximo Win Rate
Objetivo: 70-75% Win Rate (ao invés de máximo ROI)
Estratégia:
- Opera APENAS high_vol_bear (62.6% WR) e medium_bear (56.4% WR)
- Confiança mínima: 65-70% (ao invés de 10-30%)
- SEM trailing stop, SEM filtro de sábado
- Position sizing fixo e conservador
- TP ambicioso (3.0-3.5 ATR) para compensar poucos trades

Resultado esperado:
- Trades: ~400-600/ano (vs 2,400 original)
- Win Rate: 70-75%
- ROI: +1,500-2,000% (menor mas MUITO mais consistente)
- Max DD: <3%
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Validate Conservative Ultra Scalper (Max Win Rate)')
    ...
    print("=" * 80)
    print("🎯 ULTRA CONSERVATIVE SCALPER - MAXIMUM WIN RATE")
    print("=" * 80)
    ...
    print(f"   ✅ Opera APENAS: high_vol_bear (62.6% WR) + medium_bear (56.4% WR)")
    print(f"   ✅ Confiança Mínima: 65-70% (MUITO ALTA)")
    print(f"   ❌ Bloqueado: TODOS os outros regimes")
    print(f"   ❌ SEM trailing stop")
    print(f"   ❌ SEM filtro de sábado")
    print(f"   🎯 Position: Fixo e conservador (max 1.0x)")
    print(f"   🎯 Take Profit: 3.0-3.5 ATR (ambicioso)")
    print(f"   📊 Expected: 70-75% Win Rate, ~500 trades/ano")
    print()
    ...
    print("\n" + "=" * 80)
    print("📊 WALK-FORWARD RESULTS (CONSERVATIVE - MAX WIN RATE)")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("📊 REGIME-BASED PERFORMANCE (CONSERVATIVE)")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("📊 FULL BACKTEST + MONTE CARLO (CONSERVATIVE)")
    print("=" * 80)
    ...
    if full_stats.get('total_trades', 0) > 0:
        ...
        print(f"   🚫 Blocked Trades: {full_stats['blocked_trades']}")
        if full_stats.get('blocked_by_regime'):
            print(f"   Blocked by Regime: {full_stats['blocked_by_regime']}")
    ...
    print("\n" + "=" * 80)
    print("✅ CONSERVATIVE VALIDATION COMPLETE")
    print("=" * 80)
