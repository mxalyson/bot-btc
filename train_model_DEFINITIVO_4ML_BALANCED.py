"""
MODELO DEFINITIVO - 4 ML PERFEITOS (THRESHOLD BALANCEADO)
==========================================
...
print("=" * 80)
print("🚀 MODELO DEFINITIVO - 4 ML PERFEITOS (THRESHOLD BALANCEADO)")
print("=" * 80)
print()
...
class ModelWrapper:
    ...
    def __init__(self, models_list, model_weights, model_names, scaler, feature_columns, has_dl=False,
                 long_threshold=0.50, short_threshold=0.50, lookback=10):
...
def train_final_completo(df, days):
    """Treina MODELO DEFINITIVO - 4 ML PERFEITOS (THRESHOLD BALANCEADO)."""
    ...
    long_threshold = 0.50  # Neutro (ajustado de 0.35)
    short_threshold = 0.50  # Neutro (ajustado de 0.65)
...
if __name__ == "__main__":
    ...
    for days in test_periods:
        ...
        # Save
        model_file = storage_dir / f"model_DEFINITIVO_4ML_BALANCED_{days}d.pkl"
    ...
    print(f"   storage/models/model_DEFINITIVO_4ML_BALANCED_{best_days}d.pkl")
    print()
